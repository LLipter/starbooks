...
<div class="header">
        ...
        <div class="banner-top">
                <div class="container">
                    <h1>Edit</h1>
                    <em></em>
                    <h2><a href="resource/index.html">Home</a><label>/</label>Edit</a></h2>
                </div>
            </div>
	...
	<div class="login_container" id="login_conatiner">
		<div class="login">
			<form action="/starbooks/login" method="post" class="white-pink">
				<h1>
					Edit Book Info <span>Please fill all the texts in the
						fields.</span>
				</h1>
				<label> <span>Book id</span> <input type="text"
					name="user_name" />
				</label> <label> <span>Title:</span> <input type="password"
                    name="passwd" />
                </label> <label> <span>Author:</span> <input type="password"
					name="passwd" />
				<label> <span>Publisher</span> <input type="text"
					name="user_name" />		
				<label> <span>Price</span> <input type="text"
						name="user_name" />	
